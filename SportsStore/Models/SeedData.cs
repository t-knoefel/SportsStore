        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                   ...
                   new Product
                   {
                       Name = "Lifejacket", Description = "Protective and fashionable", Category = "Watersports", Price = 48.95m
                   },
                   new Product
                   {
                   ...
                   new Product
                   {
                       Name = "Corner Flags", Description = "Give your playing field a professional touch", Category = "Watersports", Price = 34.95m
                   },
                   new Product
                   {
                   ...
                   new Product
                   {
                       Name = "Unsteady Chair", Description = "Secretly give your opponent a disadvantage", Category = "Chess", Price = 29.95m
                   },
                   new Product
                   {
                       Name = "Chess Board", Description = "A fun game for the family", Category = "Chess", Price = 75
                   },
                   new Product
                   {
